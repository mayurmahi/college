          ...
          <div className="max-w-6xl mx-auto">
            <ul className="flex justify-evenly items-center gap-10 w-full mx-auto my-8">
              <li
                className={`text-center rounded-sm px-4 py-2 w-1/5 cursor-pointer ease-linear duration-300 hover:ease-linear hover:duration-300 hover:transition-all transition-all ${
                  selectedMenu === "Profile"
                    ? "border-b-2 pb-2 border-red-500 bg-red-100 rounded-sm"
                    : "bg-red-500 text-white hover:bg-red-600 border-b-2 border-red-500"
                }`}
              ...
              <li
                className={`text-center rounded-sm px-4 py-2 w-1/5 cursor-pointer ease-linear duration-300 hover:ease-linear hover:duration-300 hover:transition-all transition-all ${
                  selectedMenu === "Student"
                    ? "border-b-2 pb-2 border-indigo-500 bg-indigo-100 rounded-sm"
              ...
              <li
                className={`text-center rounded-sm px-4 py-2 w-1/5 cursor-pointer ease-linear duration-300 hover:ease-linear hover:duration-300 hover:transition-all transition-all ${
                  selectedMenu === "Branch"
                    ? "border-b-2 pb-2 border-yellow-500 bg-yellow-100 rounded-sm"
                    : "bg-yellow-500 text-white hover:bg-yellow-600 border-b-2 border-yellow-500"
                }`}
              ...
              <li
                className={`text-center rounded-sm px-4 py-2 w-1/5 cursor-pointer ease-linear duration-300 hover:ease-linear hover:duration-300 hover:transition-all transition-all ${
                  selectedMenu === "Subjects"
                    ? "border-b-2 pb-2 border-orange-500 bg-orange-100 rounded-sm"
                    : "bg-orange-500 text-white hover:bg-orange-600 border-b-2 border-orange-500"
                }`}
              ...
              <li
                className={`text-center rounded-sm px-4 py-2 w-1/5 cursor-pointer ease-linear duration-300 hover:ease-linear hover:duration-300 hover:transition-all transition-all ${
                  selectedMenu === "Admin"
                    ? "border-b-2 pb-2 border-cyan-500 bg-cyan-100 rounded-sm"
                    : "bg-cyan-500 text-white hover:bg-cyan-600 border-b-2 border-cyan-500"
                }`}
